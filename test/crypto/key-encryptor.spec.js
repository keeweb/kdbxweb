...
describe('KeyEncryptor', function() {
    ...
    it('decrypts one round', function() {
        return KeyEncryptor.encrypt(data, key, 1).then(function(res) {
    ...
    it('decrypts two rounds', function() {
        return KeyEncryptor.encrypt(data, key, 2).then(function(res) {
    ...
    it('decrypts many rounds', function() {
        return KeyEncryptor.encrypt(data, key, 10021).then(function(res) {
