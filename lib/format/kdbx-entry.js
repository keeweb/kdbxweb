 ...
 *
 * Implements remove-win OR-set CRDT with local tombstone stored in localHistoryTombstones.
 *
...
KdbxEntry.prototype._mergeHistory = function(remoteHistory, remoteLastModTime) {
    ...
    this.history.forEach(function(record) { historyMap.push(record); });
    remoteHistory.forEach(function(record) { remoteHistoryMap.push(record); });
