 ...
 * @return {KdbxGroup}
 */
KdbxGroup.prototype.createGroup = function(name) {
    var group = KdbxGroup.create(name);
 ...
 * @return {KdbxEntry}
 */
KdbxGroup.prototype.createEntry = function() {
    var entry = KdbxEntry.create();
 ...
 * @returns {KdbxGroup}
 */
KdbxGroup.create = function(name) {
