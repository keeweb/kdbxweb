...
Kdbx.prototype._buildXml = function() {
    // TODO: move to meta
    var node = XmlUtils.getChildNode(XmlUtils.getChildNode(this.xml.documentElement, XmlNames.Elem.Meta), XmlNames.Elem.HeaderHash);
    node.textContent = ByteUtils.bytesToBase64(this.meta.headerHash);
