...
Kdbx.prototype.createRecycleBin = function() {
    ...
    this.getDefaultGroup().groups.push(recycleBin);
};
...
Kdbx.prototype.createGroup = function(group, name) {
    var subGroup = KdbxGroup.create(name);
...
Kdbx.prototype.createEntry = function(group) {
    var entry = KdbxEntry.create(this.meta);
 ...
 * @param {KdbxGroup} fromGroup - source parent group
 * @param {KdbxGroup} toGroup - target parent group
 */
Kdbx.prototype.move = function(object, fromGroup, toGroup) {
    var containerProp = object instanceof KdbxGroup ? 'groups' : 'entries';
    var fromContainer = fromGroup[containerProp];
 ...
 * @param {KdbxGroup} fromGroup - parent group
 */
Kdbx.prototype.remove = function(object, fromGroup) {
    var toGroup = this.meta.recycleBinEnabled ? this.getGroup(this.meta.recycleBinUuid) : null;
    this.move(object, fromGroup, toGroup);
