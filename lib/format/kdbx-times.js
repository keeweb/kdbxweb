 ...
 * @param {Kdbx} kdbx - kxbx file
 */
KdbxTimes.prototype.write = function(parentNode, kdbx) {
    var node = XmlUtils.addChildNode(parentNode, XmlNames.Elem.Times);
    kdbx._setXmlDate(XmlUtils.addChildNode(node, XmlNames.Elem.CreationTime), this.creationTime);
    kdbx._setXmlDate(XmlUtils.addChildNode(node, XmlNames.Elem.LastModTime), this.lastModTime);
    kdbx._setXmlDate(XmlUtils.addChildNode(node, XmlNames.Elem.LastAccessTime), this.lastAccessTime);
    kdbx._setXmlDate(XmlUtils.addChildNode(node, XmlNames.Elem.ExpiryTime), this.expiryTime);
    ...
    kdbx._setXmlDate(XmlUtils.addChildNode(node, XmlNames.Elem.LocationChanged), this.locationChanged);
};
